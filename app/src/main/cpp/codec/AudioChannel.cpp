...
int AudioChannel::getPcm() {
    ...
    if (duration > 0 && javaCallHelper) {
        javaCallHelper->onDuration(THREAD_CHILD, audio_clock);
    }
...
void AudioChannel::p_volume() {


//    audioChannel = dynamic_cast<AudioChannel *>(this);
